...
namespace Projeto.Moope.Infrastructure.Migrations._002_business
{
    ...
    [Migration("20250815185319_AjusteTablesVendedor")]
    partial class AjusteTablesVendedor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Projeto.Moope.Core.Models.Vendedor", b =>
                {
                    ...
                    b.Property<Guid>("VendedorPaiId")
                        .HasColumnType("char(36)");

                    b.HasKey("Id");

                    b.HasIndex("VendedorPaiId");
